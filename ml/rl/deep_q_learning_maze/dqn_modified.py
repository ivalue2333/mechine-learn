...
class DeepQNetwork:
    ...
    def _build_net(self):
        ...
        self.a = tf.placeholder(tf.int32, [None, ], name='op_fuwu_order.txt')  # input Action
    ...
    def learn(self):
        ...
        _, cost = self.sess.run([self._train_op, self.loss],
            feed_dict={self.s: batch_memory[:, :self.n_features], self.a: batch_memory[:, self.n_features],
