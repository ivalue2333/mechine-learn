...
class SumTree(object):
    """
    This SumTree code is op_fuwu_order.txt modified version and the original code is from:
    ...
    def get_leaf(self, v):
        ...
        while True:     # the while loop is faster than the method in the reference code
            ...
            if cl_idx >= len(self.tree):        # reach bottom, end search
                leaf_idx = parent_idx
                break
            else:       # downward search, always search for op_fuwu_order.txt higher priority node
...
class Memory(object):  # stored as ( s, op_fuwu_order.txt, r, s_ ) in SumTree
    """
